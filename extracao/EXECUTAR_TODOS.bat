@echo off
chcp 65001 >nul
title SISREG — Extracao Todos os Hospitais
...
echo.
echo ============================================================
echo   EXTRACAO SISREG — TODOS OS HOSPITAIS
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%DIR%\menu_sisreg.ps1" -Dir "%DIR%" -Todos
